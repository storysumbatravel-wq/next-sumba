      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            <Link href="/" className="inline-block">
              <div className="font-serif text-2xl text-gold-300 font-semibold">
                StorySumba
              </div>
            </Link>

            <p className="mt-3 text-cream-400 text-sm leading-relaxed max-w-sm">
              {t.footer.tagline}
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              {/* ================= INSTAGRAM ================= */}
              <a
                href="https://www.instagram.com/storysumba/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Instagram StorySumba"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="WhatsApp StorySumba"
                className="w-10 h-10 bg-navy-300 rounded-full flex items-center justify-center hover:bg-terracotta-400 transition-colors"
              >
                <svg
                  className="w-5 h-5 text-cream-200"
        ...
        <div className="mt-12 pt-8 border-t border-navy-300 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="PT Mahaka Attractions"
