    ...
    <footer className="bg-navy-400 text-cream-200">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              {/* ===== INSTAGRAM ===== */}
              <button
                onClick={() => openLink("https://www.instagram.com/storysumba")}
                className="w-10 h-10 bg-navy-300 rounded-full flex items-center justify-center hover:bg-terracotta-400 transition-colors cursor-pointer"
              ...
              {/* ===== FACEBOOK ===== */}
              <button
                onClick={() => openLink("https://www.facebook.com/storysumba")}
                className="w-10 h-10 bg-navy-300 rounded-full flex items-center justify-center hover:bg-terracotta-400 transition-colors cursor-pointer"
                aria-label="Facebook"
              >
                <svg
              ...
              {/* ===== WHATSAPP ===== */}
              <button
                onClick={() => openLink("https://wa.me/6281287763530")}
                className="w-10 h-10 bg-navy-300 rounded-full flex items-center justify-center hover:bg-terracotta-400 transition-colors cursor-pointer"
                aria-label="WhatsApp"
              >
                <svg
        ...
        <div className="mt-12 pt-8 border-t border-navy-300 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          {/* Unit Bisnis dari / Subsidiary Of */}
          <button
            onClick={() => openLink("https://mahakaattraction.id")}
            className="flex items-center gap-4 md:justify-end group cursor-pointer"
            aria-label="Mahaka Attractions"
          >
